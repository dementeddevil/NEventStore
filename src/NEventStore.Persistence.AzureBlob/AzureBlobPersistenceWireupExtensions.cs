...
namespace NEventStore.Persistence.AzureBlob
{
    public static class AzureBlobPersistenceWireupExtensions
    {
        ...
        public static AzureBlobPersistenceWireup UsingAzureBlobPersistence(this Wireup wireup, string azureConnectionString, IDocumentSerializer serializer, AzureBlobPersistenceOptions options = null)
