namespace NEventStore
{
    ...
    public static class StoreEventsExtensions
    {
        ...
        public static Task<IEventStream> CreateStream(this IStoreEvents storeEvents, Guid streamId)
        {
		...
		public static Task<IEventStream> OpenStream(this IStoreEvents storeEvents, Guid streamId, int minRevision = int.MinValue, int maxRevision = int.MaxValue)
        {
        ...
        /// <exception cref="StorageUnavailableException" />
        /// <exception cref="StreamNotFoundException" />
		public static Task<IEventStream> OpenStream(this IStoreEvents storeEvents, string streamId, int minRevision = int.MinValue, int maxRevision = int.MaxValue)
        {
            EnsureStoreEventsNotNull(storeEvents);
        ...
        /// <exception cref="StorageUnavailableException" />
        /// <exception cref="StreamNotFoundException" />
		public static Task<IEventStream> OpenStream(this IStoreEvents storeEvents, string bucketId, Guid streamId, int minRevision = int.MinValue, int maxRevision = int.MaxValue)
        {
            EnsureStoreEventsNotNull(storeEvents);
